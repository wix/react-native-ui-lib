...
export default class LoaderScreen extends BaseComponent {
    render() {
        ...
        return (<Animatable.View style={[overlay ? styles.overlayContainer : styles.container]} {...animationProps}>
        <View flex center>
          <ActivityIndicator size={"large"} animating color={loaderColor ||
            (Constants.isIOS ? Colors.dark60 : ThemeManager.primaryColor)} {...others}/>
