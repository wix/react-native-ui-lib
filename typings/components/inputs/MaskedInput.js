...
export default class MaskedInput extends BaseInput {
    ...
    render() {
        ...
        <TextInput {...this.props} ref={input => {
            this.input = input;
        }} containerStyle={styles.hiddenInputContainer} style={styles.hiddenInput} enableErrors={false} hideUnderline placeholder="" {...TextInputProps} onChangeText={this.onChangeText}/>
        <TouchableOpacity activeOpacity={1} style={styles.maskedInputWrapper} onPress={this.focus}>
