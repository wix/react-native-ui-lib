...
export default class ConnectionStatusBar extends BaseComponent {
    ...
    render() {
        ...
        return (<View useSafeArea style={this.styles.absoluteContainer}>
        <View style={this.styles.container}>
          <View style={{ flex: 1, flexDirection: "row" }}>
            <Text style={this.styles.text}>{this.props.label}</Text>
            {this.props.allowDismiss && (<TouchableOpacity style={this.styles.xContainer} onPress={() => this.setState({ isCancelled: true })}>
