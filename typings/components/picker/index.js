...
class Picker extends TextInput {
    constructor(props) {
        ...
        this.onSelectedItemLayout = ({ nativeEvent: { layout: { y } } }) => {
        ...
        const childrenWithProps = React.Children.map(children, child => {
            ...
            if (!showSearch ||
                ...
                return React.cloneElement(child, {
                    ...
                    onPress: mode === Picker.modes.MULTI
    ...
    renderExpandableInput() {
        ...
        return (<TouchableOpacity style={styles.pickerInputWrapper} activeOpacity={1} onPress={this.handlePickerOnPress}>
        <Text style={[
            this.styles.input,
            typography,
            { color },
    ...
    renderExpandableModal() {
        ...
        return (<PickerModal visible={showExpandableModal} scrollPosition={selectedItemPosition} enableModalBlur={enableModalBlur} topBarProps={{
            ...topBarProps,
            onCancel: this.cancelSelect,
            onDone: mode === Picker.modes.MULTI
                ? () => this.onDoneSelecting(this.state.value)
                : undefined
        }} showSearch={showSearch} searchStyle={searchStyle} searchPlaceholder={searchPlaceholder} onSearchChange={this.onSearchChange}>
