...
export default class GridListItem extends BaseComponent {
    ...
    renderTop() {
        return <View style={this.styles.topContainer}>{this.renderImage()}</View>;
    }
    renderBottom() {
        return (<View style={this.styles.bottomContainer}>
    ...
    renderSecondaryTitle() {
        ...
        return <Text style={this.styles.secondaryTitleText}>{secondaryTitle}</Text>;
    }
    renderTitle() {
    ...
    renderSubtitle() {
        ...
        return <Text style={this.styles.subtitleText}>{subtitle}</Text>;
    }
    render() {
        const { onPress, disabled } = this.props;
        const animationProps = this.extractAnimationProps();
        const Container = onPress && !disabled ? TouchableOpacity : View;
        return (<Container style={[this.styles.container, disabled && this.containerDisabled]} onPress={onPress}>
        <Animatable.View {...animationProps} style={[
...
GridListItem.displayName = "IGNORE";
