...
class GridList extends BaseComponent {
    ...
    renderRow(row, sectionId, rowId) {
        ...
        return (<View key={rowId} style={this.styles.row}>
    ...
    render() {
        ...
        return (<ListView dataSource={this.state.dataSource} pageSize={itemsInRow} renderRow={this.renderRow} {...others} contentContainerStyle={[this.styles.container, contentContainerStyle]}/>);
    }
}
GridList.displayName = "IGNORE";
