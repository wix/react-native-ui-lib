module.exports = {
  ...
  get TextInputKeyboardMangerIOS() { return require('./KeyboardInput').TextInputKeyboardMangerIOS; },
  get CustomKeyboardView() { return require('./KeyboardInput').CustomKeyboardView; },
