...
class KeyboardAccessoryView extends Component {
  static propTypes = {
     ...
     * true to save space to screen's safe area.
     * Supported in all iOS devices that has notch.
     * Other devices (including android) will avoid it and won't have space at the bottom.
     *
     * default: true
     */
