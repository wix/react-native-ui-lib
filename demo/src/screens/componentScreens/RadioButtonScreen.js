      ...
      <View flex useSafeArea>
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{padding: 20}}>
          ...
          <RadioGroup gap-s4 marginT-30 initialValue={this.state.value} onValueChange={value => this.setState({value})}>
            ...
            <View row>
              {this.renderRadioButtonWithImage('yes', Assets.internal.icons.check, {tintColor: 'green'})}
              {this.renderRadioButtonWithImage('no', Assets.internal.icons.x, {tintColor: 'red'})}
            </View>
