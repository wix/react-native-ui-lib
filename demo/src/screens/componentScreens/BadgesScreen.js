  ...
  render() {
    return (
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Text text80 row center marginT-10 marginB-15> Pimple Badges - size: `pimpleBig`</Text>
        <View row center>
        ...
        <Text text80 row center marginT-20 marginB-15> Pimple Badges - size: `pimpleSmall`</Text>
        <View row center>
