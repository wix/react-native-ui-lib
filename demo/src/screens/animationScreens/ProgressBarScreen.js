            ...
            return (
              <View key={index}>
                <ProgressBar
                  ...
                  backgroundColor={[Colors.red40, Colors.purple40, Colors.blue30, Colors.green40][index]}
                  progressBackgroundColor={[Colors.red70, Colors.purple70, Colors.blue70, Colors.green70][index]}
                />
