...
module.exports = {
  ...
  get screens() {
    return {
      ...
      get KeyboardTrackingViewScreen() {
        return require('./screens/nativeComponentScreens/KeyboardTrackingViewScreen').default;
      },
      get KeyboardAccessoryViewScreen() {
        return require('./screens/nativeComponentScreens/keyboardAccessory/KeyboardAccessoryViewScreen').default;
      },
