...
import Reanimated, {Easing as _Easing, EasingNode, useSharedValue} from 'react-native-reanimated';
...
function TabController({selectedIndex, asCarousel, items, onChangeIndex, carouselPageWidth, children}: TabControllerProps) {
