module.exports = {
  ...
  get ColorPalette() { return require('./components').ColorPalette; },
  get ColorPicker() { return require('./components').ColorPicker; },
  get ColorSwatch() { return require('./components').ColorSwatch; },
