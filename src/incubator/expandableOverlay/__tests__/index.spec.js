...
import ExpandableOverlay from "../index";
...
const TestCase = props => {
  return <ExpandableOverlay migrateDialog expandableContent={<Text>{universe}</Text>} {...props} testID={testID}>
      <View>
...
const getDriver = props => {
  ...
  const driver = ExpandableOverlayDriver({
    renderTree,
    testID
  }, props.useDialog ?? false);
  return {
    driver,
    renderTree
  };
