...
const Shadows = {
  ...
  /* Old Presets */
  white10: {
    top: {shadowColor: isDark ? 'transparent' : Colors.grey20, shadowOpacity: 0.04, shadowRadius: 13.5},
    bottom: {
      shadowColor: isDark ? 'transparent' : Colors.grey10,
      shadowOpacity: 0.09,
      shadowRadius: 2,
      shadowOffset: {height: 2, width: 0}
    }
  ...
  white20: {
    top: {shadowColor: isDark ? 'transparent' : Colors.grey20, shadowOpacity: 0.06, shadowRadius: 15},
    bottom: {
      shadowColor: isDark ? 'transparent' : Colors.grey10,
      shadowOpacity: 0.04,
      shadowRadius: 3,
  ...
  white30: {
    top: {shadowColor: isDark ? 'transparent' : Colors.grey20, shadowOpacity: 0.05, shadowRadius: 12},
    bottom: {
      shadowColor: isDark ? 'transparent' : Colors.grey10,
      shadowOpacity: 0.06,
      shadowRadius: 4.5,
  ...
  white40: {
    top: {shadowColor: isDark ? 'transparent' : Colors.grey20, shadowOpacity: 0.06, shadowRadius: 18.5},
    bottom: {
      shadowColor: isDark ? 'transparent' : Colors.grey10,
      shadowOpacity: 0.07,
      shadowRadius: 8.5,
  ...
  grey10: {
    top: {shadowColor: isDark ? 'transparent' : Colors.grey20, shadowOpacity: 0.02, shadowRadius: 13.5},
    bottom: {
      shadowColor: isDark ? 'transparent' : Colors.grey10,
      shadowOpacity: 0.03,
      shadowRadius: 2,
  ...
  grey20: {
    top: {shadowColor: isDark ? 'transparent' : Colors.grey20, shadowOpacity: 0.03, shadowRadius: 15},
    bottom: {
      shadowColor: isDark ? 'transparent' : Colors.grey10,
      shadowOpacity: 0.02,
      shadowRadius: 3,
  ...
  grey30: {
    ...
    bottom: {
      shadowColor: isDark ? 'transparent' : Colors.grey20,
      shadowOpacity: 0.04,
      shadowRadius: 8,
