...
let screenHeight = () => isWeb ? (queryWebFrameDevice()?.clientHeight ?? 0) : Dimensions.get('screen').height;
let screenWidth = () => isWeb ? (queryWebFrameDevice()?.clientWidth ?? 0) : Dimensions.get('screen').width;
