module.exports = {
  rules: {
    ...
    'string-deprecation': require('./lib/rules/string-deprecation'),
    ...
    'string-deprecation_warn': require('./lib/rules/string-deprecation'),
    ...
    'string-deprecation_error': require('./lib/rules/string-deprecation'),
