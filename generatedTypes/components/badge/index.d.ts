...
export declare type BadgePropTypes = ViewProps & TouchableOpacityProps & {
    /**
 ...
 */
declare class Badge extends PureComponent<BadgePropTypes> {
...
declare function createStyles(props: BadgePropTypes): {
    badge: {
