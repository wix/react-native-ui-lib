...
export { Text };
declare const _default: React.ComponentClass<(RNTextProps & import("../../commons/modifiers").CustomModifier & Partial<Record<"margin" | "marginL" | "marginT" | "marginR" | "marginB" | "marginH" | "marginV", number>> & {
    /**
     * color of the text
     */
