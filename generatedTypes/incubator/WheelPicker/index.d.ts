...
declare const WheelPicker: React.MemoExoticComponent<({ items: propItems, itemHeight, numberOfVisibleRows, activeTextColor, inactiveTextColor, textStyle, label, labelStyle, labelProps, onChange: _onChange, style, children, selectedValue, testID }: WheelPickerProps) => JSX.Element>;
