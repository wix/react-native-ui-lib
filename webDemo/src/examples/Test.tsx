  ...
  useEffect(() => {
    const animateLogo = () => {
      ...
      Animated.timing(scaleAnim, {
        ...
        duration: 4000, // Duration set to 4 seconds
        useNativeDriver: true // Use native driver for better performance
      }).start(() => {
        // Reverse the animation back to original size
        Animated.timing(scaleAnim, {
          toValue: 1,
          duration: 4000, // Duration set to 4 seconds for reverse
          useNativeDriver: true
        }).start(animateLogo); // Restart the animation
      });
    };
    ...
    <View style={styles.app}>
      <View style={styles.header}>
        <Animated.Image
          ...
          resizeMode="contain"
          style={[styles.logo, {transform: [{scaleX: scaleAnim, scaleY: scaleAnim}]}]} // Apply scale transformation
        />
